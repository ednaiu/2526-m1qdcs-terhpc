...
KERNEL = "saxpy"
MAX_ITERATIONS = 10
GOAL_GFLOPS = 15.0  # Performance goal
TEMPLATE_PATH = "week 4/agentic_optimization/blas1_template.c"
SRC_PATH = "week 4/src/blas1.c"
BACKUP_PATH = "week 4/src/blas1.c.bak"
BENCH_CMD = ["./week 4/bin/bench_blas1", "--n", "10000000", "--kernel", KERNEL, "--mode", "avx2"]

def run_bench():
    """Compiles and runs the benchmark, returning median GFLOPS."""
    try:
        # Build
        subprocess.run(["make", "-C", "week 4", "bin/bench_blas1"], check=True, capture_output=True)
        # Run
