...
static void w_sscal_scalar(void *a) { sscal_arg *p = a; sscal_scalar(p->n, p->alpha, p->x); }
static void w_sscal_avx2  (void *a) { sscal_arg *p = a; sscal_avx2  (p->n, p->alpha, p->x); }
static void w_sscal_par   (void *a) { sscal_arg *p = a; sscal       (p->n, p->alpha, p->x); }
...
static void w_scopy_scalar(void *a) { scopy_arg *p = a; scopy_scalar(p->n, p->x, p->y); }
static void w_scopy_avx2  (void *a) { scopy_arg *p = a; scopy_avx2  (p->n, p->x, p->y); }
static void w_scopy_par   (void *a) { scopy_arg *p = a; scopy       (p->n, p->x, p->y); }
static void w_scopy_ob    (void *a) { scopy_arg *p = a; cblas_scopy  (p->n, p->x, 1, p->y, 1); }

/* sswap */
typedef struct { int n; float *x; float *y; } sswap_arg;
static void w_sswap_scalar(void *a) { sswap_arg *p = a; sswap_scalar(p->n, p->x, p->y); }
static void w_sswap_avx2  (void *a) { sswap_arg *p = a; sswap_avx2  (p->n, p->x, p->y); }
static void w_sswap_par   (void *a) { sswap_arg *p = a; sswap       (p->n, p->x, p->y); }
...
static void w_saxpy_scalar(void *a) { saxpy_arg *p = a; saxpy_scalar(p->n, p->alpha, p->x, p->y); }
static void w_saxpy_avx2  (void *a) { saxpy_arg *p = a; saxpy_avx2  (p->n, p->alpha, p->x, p->y); }
static void w_saxpy_par   (void *a) { saxpy_arg *p = a; saxpy       (p->n, p->alpha, p->x, p->y); }
...
static void w_sdot_scalar(void *a) { sdot_arg *p = a; p->r = sdot_scalar(p->n, p->x, p->y); }
static void w_sdot_avx2  (void *a) { sdot_arg *p = a; p->r = sdot_avx2  (p->n, p->x, p->y); }
static void w_sdot_par   (void *a) { sdot_arg *p = a; p->r = sdot       (p->n, p->x, p->y); }
...
static void w_snrm2_scalar(void *a) { snrm2_arg *p = a; p->r = snrm2_scalar(p->n, p->x); }
static void w_snrm2_avx2  (void *a) { snrm2_arg *p = a; p->r = snrm2_avx2  (p->n, p->x); }
static void w_snrm2_par   (void *a) { snrm2_arg *p = a; p->r = snrm2       (p->n, p->x); }
...
static void w_sasum_scalar(void *a) { sasum_arg *p = a; p->r = sasum_scalar(p->n, p->x); }
static void w_sasum_avx2  (void *a) { sasum_arg *p = a; p->r = sasum_avx2  (p->n, p->x); }
static void w_sasum_par   (void *a) { sasum_arg *p = a; p->r = sasum       (p->n, p->x); }
...
static void w_isamax_scalar(void *a) { isamax_arg *p = a; p->r = isamax_scalar(p->n, p->x); }
static void w_isamax_avx2  (void *a) { isamax_arg *p = a; p->r = isamax_avx2  (p->n, p->x); }
static void w_isamax_par   (void *a) { isamax_arg *p = a; p->r = isamax       (p->n, p->x); }
...
static void w_srot_scalar(void *a) { srot_arg *p = a; srot_scalar(p->n, p->x, p->y, p->c, p->s); rot_restore(p); }
static void w_srot_avx2  (void *a) { srot_arg *p = a; srot_avx2  (p->n, p->x, p->y, p->c, p->s); rot_restore(p); }
static void w_srot_par   (void *a) { srot_arg *p = a; srot       (p->n, p->x, p->y, p->c, p->s); rot_restore(p); }
